...
The latest codata constants were released in 2022. The complete list of available
constants is listed below. 
Older values from 2010, 2014 and 2018 are also available. They can be accessed
by adding the suffix `_<year>`.
