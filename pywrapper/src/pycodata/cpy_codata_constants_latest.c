...
static struct PyModuleDef constants_latest = {PyModuleDef_HEAD_INIT, "constants_latest", module_docstring, -1, myMethods};

PyMODINIT_FUNC PyInit_constants_latest(void){
    PyObject *m;
    PyObject *d;
    PyObject *v;
    m = PyModule_Create(&constants_latest);
