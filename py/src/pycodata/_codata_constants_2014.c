...
PyMODINIT_FUNC PyInit_constants_2014(void){
    ...
    PyDict_SetItemString(d, "LATTICE_SPACING_OF_IDEAL_SI_220_2014", constant);
    Py_DECREF(constant);
    ...
    PyDict_SetItemString(d, "ATOMIC_UNIT_OF_MOMENTUM_2014", constant);
    Py_DECREF(constant);
    ...
    PyDict_SetItemString(d, "BOHR_MAGNETON_IN_INVERSE_METER_PER_TESLA_2014", constant);
    Py_DECREF(constant);
    ...
    PyDict_SetItemString(d, "BOLTZMANN_CONSTANT_IN_INVERSE_METER_PER_KELVIN_2014", constant);
    Py_DECREF(constant);
    ...
    PyDict_SetItemString(d, "REDUCED_COMPTON_WAVELENGTH_2014", constant);
    Py_DECREF(constant);
    ...
    PyDict_SetItemString(d, "COPPER_X_UNIT_2014", constant);
    Py_DECREF(constant);
    ...
    PyDict_SetItemString(d, "VACUUM_ELECTRIC_PERMITTIVITY_2014", constant);
    Py_DECREF(constant);
    ...
    PyDict_SetItemString(d, "ELECTRON_GYROMAG_RATIO_IN_MHZ_T_2014", constant);
    Py_DECREF(constant);
    ...
    PyDict_SetItemString(d, "VACUUM_MAG_PERMEABILITY_2014", constant);
    Py_DECREF(constant);
    ...
    PyDict_SetItemString(d, "MOLYBDENUM_X_UNIT_2014", constant);
    Py_DECREF(constant);
    ...
    PyDict_SetItemString(d, "REDUCED_MUON_COMPTON_WAVELENGTH_2014", constant);
    Py_DECREF(constant);
    ...
    PyDict_SetItemString(d, "NATURAL_UNIT_OF_MOMENTUM_2014", constant);
    Py_DECREF(constant);
    ...
    PyDict_SetItemString(d, "NATURAL_UNIT_OF_MOMENTUM_IN_MEV_C_2014", constant);
    Py_DECREF(constant);
    ...
    PyDict_SetItemString(d, "REDUCED_NEUTRON_COMPTON_WAVELENGTH_2014", constant);
    Py_DECREF(constant);
    ...
    PyDict_SetItemString(d, "NEUTRON_GYROMAG_RATIO_IN_MHZ_T_2014", constant);
    Py_DECREF(constant);
    ...
    PyDict_SetItemString(d, "NUCLEAR_MAGNETON_IN_INVERSE_METER_PER_TESLA_2014", constant);
    Py_DECREF(constant);
    ...
    PyDict_SetItemString(d, "PLANCK_CONSTANT_IN_EV_HZ_2014", constant);
    Py_DECREF(constant);
    ...
    PyDict_SetItemString(d, "REDUCED_PLANCK_CONSTANT_2014", constant);
    Py_DECREF(constant);
    ...
    PyDict_SetItemString(d, "REDUCED_PLANCK_CONSTANT_IN_EV_S_2014", constant);
    Py_DECREF(constant);
    ...
    PyDict_SetItemString(d, "REDUCED_PLANCK_CONSTANT_TIMES_C_IN_MEV_FM_2014", constant);
    Py_DECREF(constant);
    ...
    PyDict_SetItemString(d, "REDUCED_PROTON_COMPTON_WAVELENGTH_2014", constant);
    Py_DECREF(constant);
    ...
    PyDict_SetItemString(d, "PROTON_GYROMAG_RATIO_IN_MHZ_T_2014", constant);
    Py_DECREF(constant);
    ...
    PyDict_SetItemString(d, "SHIELDED_HELION_GYROMAG_RATIO_IN_MHZ_T_2014", constant);
    Py_DECREF(constant);
    ...
    PyDict_SetItemString(d, "SHIELDED_PROTON_GYROMAG_RATIO_IN_MHZ_T_2014", constant);
    Py_DECREF(constant);
    ...
    PyDict_SetItemString(d, "REDUCED_TAU_COMPTON_WAVELENGTH_2014", constant);
    Py_DECREF(constant);
    ...
    PyDict_SetItemString(d, "TAU_ENERGY_EQUIVALENT_2014", constant);
    Py_DECREF(constant);
