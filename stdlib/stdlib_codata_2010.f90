...
integer(int32), parameter, public :: YEAR = 2010 !! Year of release.

type(codata_constant), parameter, public :: LATTICE_SPACING_OF_SILICON = &
codata_constant("{220} lattice spacing of silicon", &
...
type(codata_constant), parameter, public :: ATOMIC_UNIT_OF_MOMUM = &
codata_constant("atomic unit of mom.um", &
...
type(codata_constant), parameter, public :: BOHR_MAGNETON_IN_INVERSE_METERS_PER_TESLA = &
codata_constant("Bohr magneton in inverse meters per tesla", &
...
type(codata_constant), parameter, public :: BOLTZMANN_CONSTANT_IN_INVERSE_METERS_PER_KELVIN = &
codata_constant("Boltzmann constant in inverse meters per kelvin", &
...
type(codata_constant), parameter, public :: COMPTON_WAVELENGTH_OVER_2_PI = &
codata_constant("Compton wavelength over 2 pi", &
...
type(codata_constant), parameter, public :: CU_X_UNIT = &
codata_constant("Cu x unit", &
...
type(codata_constant), parameter, public :: ELECTRIC_CONSTANT = &
codata_constant("electric constant", &
...
type(codata_constant), parameter, public :: ELECTRON_GYROMAG_RATIO_OVER_2_PI = &
codata_constant("electron gyromag. ratio over 2 pi", &
...
type(codata_constant), parameter, public :: ELEMENTARY_CHARGE_OVER_H = &
...
type(codata_constant), parameter, public :: FARADAY_CONSTANT_FOR_CONVENTIONAL_ELECTRIC_CURRENT = &
codata_constant("Faraday constant for conventional electric current", &
...
type(codata_constant), parameter, public :: MAG_CONSTANT = &
codata_constant("mag. constant", &
...
type(codata_constant), parameter, public :: MOLAR_PLANCK_CONSTANT_TIMES_C = &
codata_constant("molar Planck constant times c", &
...
type(codata_constant), parameter, public :: MO_X_UNIT = &
codata_constant("Mo x unit", &
...
type(codata_constant), parameter, public :: MUON_COMPTON_WAVELENGTH_OVER_2_PI = &
codata_constant("muon Compton wavelength over 2 pi", &
...
type(codata_constant), parameter, public :: NATURAL_UNIT_OF_MOMUM = &
codata_constant("natural unit of mom.um", &
2.73092429e-22_dp, 0.00000012e-22_dp, &
"kg m s^-1") !! natural unit of mom.um

type(codata_constant), parameter, public :: NATURAL_UNIT_OF_MOMUM_IN_MEV_C = &
codata_constant("natural unit of mom.um in MeV/c", &
0.510998928_dp, 0.000000011_dp, &
...
type(codata_constant), parameter, public :: NEUTRON_COMPTON_WAVELENGTH_OVER_2_PI = &
codata_constant("neutron Compton wavelength over 2 pi", &
...
type(codata_constant), parameter, public :: NEUTRON_GYROMAG_RATIO_OVER_2_PI = &
codata_constant("neutron gyromag. ratio over 2 pi", &
...
type(codata_constant), parameter, public :: NUCLEAR_MAGNETON_IN_INVERSE_METERS_PER_TESLA = &
codata_constant("nuclear magneton in inverse meters per tesla", &
...
type(codata_constant), parameter, public :: PLANCK_CONSTANT_IN_EV_S = &
codata_constant("Planck constant in eV s", &
4.135667516e-15_dp, 0.000000091e-15_dp, &
"eV s") !! Planck constant in eV s

type(codata_constant), parameter, public :: PLANCK_CONSTANT_OVER_2_PI = &
codata_constant("Planck constant over 2 pi", &
1.054571726e-34_dp, 0.000000047e-34_dp, &
"J s") !! Planck constant over 2 pi

type(codata_constant), parameter, public :: PLANCK_CONSTANT_OVER_2_PI_IN_EV_S = &
codata_constant("Planck constant over 2 pi in eV s", &
6.58211928e-16_dp, 0.00000015e-16_dp, &
"eV s") !! Planck constant over 2 pi in eV s

type(codata_constant), parameter, public :: PLANCK_CONSTANT_OVER_2_PI_TIMES_C_IN_MEV_FM = &
codata_constant("Planck constant over 2 pi times c in MeV fm", &
...
type(codata_constant), parameter, public :: PROTON_COMPTON_WAVELENGTH_OVER_2_PI = &
codata_constant("proton Compton wavelength over 2 pi", &
...
type(codata_constant), parameter, public :: PROTON_GYROMAG_RATIO_OVER_2_PI = &
codata_constant("proton gyromag. ratio over 2 pi", &
...
type(codata_constant), parameter, public :: SHIELDED_HELION_GYROMAG_RATIO_OVER_2_PI = &
codata_constant("shielded helion gyromag. ratio over 2 pi", &
...
type(codata_constant), parameter, public :: SHIELDED_PROTON_GYROMAG_RATIO_OVER_2_PI = &
codata_constant("shielded proton gyromag. ratio over 2 pi", &
...
type(codata_constant), parameter, public :: TAU_COMPTON_WAVELENGTH_OVER_2_PI = &
codata_constant("tau Compton wavelength over 2 pi", &
...
type(codata_constant), parameter, public :: TAU_MASS_ENERGY_EQUIVALENT_IN_MEV = &
codata_constant("tau mass energy equivalent in MeV", &
1776.82_dp, 0.16_dp, &
