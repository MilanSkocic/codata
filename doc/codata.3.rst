...
double precision reals.** The names are quite long and can be aliased
with shorter names.
...
The derived type codata_constant_type defines 2 type-bound procedures:
   ...
   **o print**
      to print the values of the constant members;

   **o to_real**
      to get the value or the uncertainty to the desired precision.
