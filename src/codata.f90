...
use iso_c_binding
implicit none
real(c_double), parameter :: ALPHA_PARTICLE_ELECTRON_MASS_RATIO                           = 7294.29954142            !!                         
real(c_double), parameter :: D_ALPHA_PARTICLE_ELECTRON_MASS_RATIO                         = 0.00000024               !!                         
...
real(c_double), parameter :: ALPHA_PARTICLE_MASS_ENERGY_EQUIVALENT_IN_MEV                 = 3727.3794066             !!MeV                      
real(c_double), parameter :: D_ALPHA_PARTICLE_MASS_ENERGY_EQUIVALENT_IN_MEV               = 0.0000011                !!MeV                      

real(c_double), parameter :: ALPHA_PARTICLE_MASS_IN_U                                     = 4.001506179127           !!u                        
real(c_double), parameter :: D_ALPHA_PARTICLE_MASS_IN_U                                   = 0.000000000063           !!u                        
...
real(c_double), parameter :: ALPHA_PARTICLE_PROTON_MASS_RATIO                             = 3.97259969009            !!                         
real(c_double), parameter :: D_ALPHA_PARTICLE_PROTON_MASS_RATIO                           = 0.00000000022            !!                         

real(c_double), parameter :: ALPHA_PARTICLE_RELATIVE_ATOMIC_MASS                          = 4.001506179127           !!                         
real(c_double), parameter :: D_ALPHA_PARTICLE_RELATIVE_ATOMIC_MASS                        = 0.000000000063           !!                         
...
real(c_double), parameter :: ATOMIC_MASS_CONSTANT_ENERGY_EQUIVALENT_IN_MEV                = 931.49410242             !!MeV                      
real(c_double), parameter :: D_ATOMIC_MASS_CONSTANT_ENERGY_EQUIVALENT_IN_MEV              = 0.00000028               !!MeV                      
...
real(c_double), parameter :: D_ATOMIC_UNIT_OF_ACTION                                      = 0.0                      !!J s                      

real(c_double), parameter :: ATOMIC_UNIT_OF_CHARGE                                        = 1.602176634d-19          !!C                        
real(c_double), parameter :: D_ATOMIC_UNIT_OF_CHARGE                                      = 0.0                      !!C                        
...
real(c_double), parameter :: ATOMIC_UNIT_OF_ELECTRIC_POTENTIAL                            = 27.211386245988          !!V                        
real(c_double), parameter :: D_ATOMIC_UNIT_OF_ELECTRIC_POTENTIAL                          = 0.000000000053           !!V                        
...
real(c_double), parameter :: D_AVOGADRO_CONSTANT                                          = 0.0                      !!mol^-1                   
...
real(c_double), parameter :: BOHR_MAGNETON_IN_INVERSE_METER_PER_TESLA                     = 46.686447783             !!m^-1 T^-1                
real(c_double), parameter :: D_BOHR_MAGNETON_IN_INVERSE_METER_PER_TESLA                   = 0.000000014              !!m^-1 T^-1                

real(c_double), parameter :: BOHR_MAGNETON_IN_K_T                                         = 0.67171381563            !!K T^-1                   
real(c_double), parameter :: D_BOHR_MAGNETON_IN_K_T                                       = 0.00000000020            !!K T^-1                   
...
real(c_double), parameter :: D_BOLTZMANN_CONSTANT                                         = 0.0                      !!J K^-1                   

real(c_double), parameter :: BOLTZMANN_CONSTANT_IN_EV_K                                   = 8.617333262d-5           !!eV K^-1                  
real(c_double), parameter :: D_BOLTZMANN_CONSTANT_IN_EV_K                                 = 0.0                      !!eV K^-1                  

real(c_double), parameter :: BOLTZMANN_CONSTANT_IN_HZ_K                                   = 2.083661912d10           !!Hz K^-1                  
real(c_double), parameter :: D_BOLTZMANN_CONSTANT_IN_HZ_K                                 = 0.0                      !!Hz K^-1                  

real(c_double), parameter :: BOLTZMANN_CONSTANT_IN_INVERSE_METER_PER_KELVIN               = 69.50348004              !!m^-1 K^-1                
real(c_double), parameter :: D_BOLTZMANN_CONSTANT_IN_INVERSE_METER_PER_KELVIN             = 0.0                      !!m^-1 K^-1                

real(c_double), parameter :: CHARACTERISTIC_IMPEDANCE_OF_VACUUM                           = 376.730313668            !!ohm                      
real(c_double), parameter :: D_CHARACTERISTIC_IMPEDANCE_OF_VACUUM                         = 0.000000057              !!ohm                      
...
real(c_double), parameter :: D_CONDUCTANCE_QUANTUM                                        = 0.0                      !!S                        

real(c_double), parameter :: CONVENTIONAL_VALUE_OF_AMPERE_90                              = 1.00000008887            !!A                        
real(c_double), parameter :: D_CONVENTIONAL_VALUE_OF_AMPERE_90                            = 0.0                      !!A                        

real(c_double), parameter :: CONVENTIONAL_VALUE_OF_COULOMB_90                             = 1.00000008887            !!C                        
real(c_double), parameter :: D_CONVENTIONAL_VALUE_OF_COULOMB_90                           = 0.0                      !!C                        

real(c_double), parameter :: CONVENTIONAL_VALUE_OF_FARAD_90                               = 0.99999998220            !!F                        
real(c_double), parameter :: D_CONVENTIONAL_VALUE_OF_FARAD_90                             = 0.0                      !!F                        

real(c_double), parameter :: CONVENTIONAL_VALUE_OF_HENRY_90                               = 1.00000001779            !!H                        
real(c_double), parameter :: D_CONVENTIONAL_VALUE_OF_HENRY_90                             = 0.0                      !!H                        

real(c_double), parameter :: CONVENTIONAL_VALUE_OF_JOSEPHSON_CONSTANT                     = 483597.9d9               !!Hz V^-1                  
real(c_double), parameter :: D_CONVENTIONAL_VALUE_OF_JOSEPHSON_CONSTANT                   = 0.0                      !!Hz V^-1                  

real(c_double), parameter :: CONVENTIONAL_VALUE_OF_OHM_90                                 = 1.00000001779            !!ohm                      
real(c_double), parameter :: D_CONVENTIONAL_VALUE_OF_OHM_90                               = 0.0                      !!ohm                      

real(c_double), parameter :: CONVENTIONAL_VALUE_OF_VOLT_90                                = 1.00000010666            !!V                        
real(c_double), parameter :: D_CONVENTIONAL_VALUE_OF_VOLT_90                              = 0.0                      !!V                        

real(c_double), parameter :: CONVENTIONAL_VALUE_OF_VON_KLITZING_CONSTANT                  = 25812.807                !!ohm                      
real(c_double), parameter :: D_CONVENTIONAL_VALUE_OF_VON_KLITZING_CONSTANT                = 0.0                      !!ohm                      

real(c_double), parameter :: CONVENTIONAL_VALUE_OF_WATT_90                                = 1.00000019553            !!W                        
real(c_double), parameter :: D_CONVENTIONAL_VALUE_OF_WATT_90                              = 0.0                      !!W                        
...
real(c_double), parameter :: DEUTERON_ELECTRON_MASS_RATIO                                 = 3670.48296788            !!                         
real(c_double), parameter :: D_DEUTERON_ELECTRON_MASS_RATIO                               = 0.00000013               !!                         

real(c_double), parameter :: DEUTERON_G_FACTOR                                            = 0.8574382338             !!                         
real(c_double), parameter :: D_DEUTERON_G_FACTOR                                          = 0.0000000022             !!                         
...
real(c_double), parameter :: DEUTERON_MAG__MOM__TO_NUCLEAR_MAGNETON_RATIO                 = 0.8574382338             !!                         
real(c_double), parameter :: D_DEUTERON_MAG__MOM__TO_NUCLEAR_MAGNETON_RATIO               = 0.0000000022             !!                         
...
real(c_double), parameter :: DEUTERON_MASS_ENERGY_EQUIVALENT_IN_MEV                       = 1875.61294257            !!MeV                      
real(c_double), parameter :: D_DEUTERON_MASS_ENERGY_EQUIVALENT_IN_MEV                     = 0.00000057               !!MeV                      

real(c_double), parameter :: DEUTERON_MASS_IN_U                                           = 2.013553212745           !!u                        
real(c_double), parameter :: D_DEUTERON_MASS_IN_U                                         = 0.000000000040           !!u                        
...
real(c_double), parameter :: DEUTERON_NEUTRON_MAG__MOM__RATIO                             = -0.44820653              !!                         
real(c_double), parameter :: D_DEUTERON_NEUTRON_MAG__MOM__RATIO                           = 0.00000011               !!                         

real(c_double), parameter :: DEUTERON_PROTON_MAG__MOM__RATIO                              = 0.30701220939            !!                         
real(c_double), parameter :: D_DEUTERON_PROTON_MAG__MOM__RATIO                            = 0.00000000079            !!                         

real(c_double), parameter :: DEUTERON_PROTON_MASS_RATIO                                   = 1.99900750139            !!                         
real(c_double), parameter :: D_DEUTERON_PROTON_MASS_RATIO                                 = 0.00000000011            !!                         

real(c_double), parameter :: DEUTERON_RELATIVE_ATOMIC_MASS                                = 2.013553212745           !!                         
real(c_double), parameter :: D_DEUTERON_RELATIVE_ATOMIC_MASS                              = 0.000000000040           !!                         
...
real(c_double), parameter :: ELECTRON_DEUTERON_MAG__MOM__RATIO                            = -2143.9234915            !!                         
real(c_double), parameter :: D_ELECTRON_DEUTERON_MAG__MOM__RATIO                          = 0.0000056                !!                         
...
real(c_double), parameter :: ELECTRON_G_FACTOR                                            = -2.00231930436256        !!                         
real(c_double), parameter :: D_ELECTRON_G_FACTOR                                          = 0.00000000000035         !!                         
...
real(c_double), parameter :: ELECTRON_GYROMAG__RATIO_IN_MHZ_T                             = 28024.9514242            !!MHz T^-1                 
real(c_double), parameter :: D_ELECTRON_GYROMAG__RATIO_IN_MHZ_T                           = 0.0000085                !!MHz T^-1                 
...
real(c_double), parameter :: ELECTRON_MAG__MOM__TO_BOHR_MAGNETON_RATIO                    = -1.00115965218128        !!                         
real(c_double), parameter :: D_ELECTRON_MAG__MOM__TO_BOHR_MAGNETON_RATIO                  = 0.00000000000018         !!                         

real(c_double), parameter :: ELECTRON_MAG__MOM__TO_NUCLEAR_MAGNETON_RATIO                 = -1838.28197188           !!                         
real(c_double), parameter :: D_ELECTRON_MAG__MOM__TO_NUCLEAR_MAGNETON_RATIO               = 0.00000011               !!                         
...
real(c_double), parameter :: ELECTRON_MASS_ENERGY_EQUIVALENT_IN_MEV                       = 0.51099895000            !!MeV                      
real(c_double), parameter :: D_ELECTRON_MASS_ENERGY_EQUIVALENT_IN_MEV                     = 0.00000000015            !!MeV                      
...
real(c_double), parameter :: ELECTRON_MUON_MAG__MOM__RATIO                                = 206.7669883              !!                         
real(c_double), parameter :: D_ELECTRON_MUON_MAG__MOM__RATIO                              = 0.0000046                !!                         
...
real(c_double), parameter :: ELECTRON_NEUTRON_MAG__MOM__RATIO                             = 960.92050                !!                         
real(c_double), parameter :: D_ELECTRON_NEUTRON_MAG__MOM__RATIO                           = 0.00023                  !!                         
...
real(c_double), parameter :: ELECTRON_PROTON_MAG__MOM__RATIO                              = -658.21068789            !!                         
real(c_double), parameter :: D_ELECTRON_PROTON_MAG__MOM__RATIO                            = 0.00000020               !!                         
...
real(c_double), parameter :: ELECTRON_TO_SHIELDED_HELION_MAG__MOM__RATIO                  = 864.058257               !!                         
real(c_double), parameter :: D_ELECTRON_TO_SHIELDED_HELION_MAG__MOM__RATIO                = 0.000010                 !!                         

real(c_double), parameter :: ELECTRON_TO_SHIELDED_PROTON_MAG__MOM__RATIO                  = -658.2275971             !!                         
real(c_double), parameter :: D_ELECTRON_TO_SHIELDED_PROTON_MAG__MOM__RATIO                = 0.0000072                !!                         
...
real(c_double), parameter :: D_ELECTRON_VOLT                                              = 0.0                      !!J                        
...
real(c_double), parameter :: D_ELECTRON_VOLT_HERTZ_RELATIONSHIP                           = 0.0                      !!Hz                       

real(c_double), parameter :: ELECTRON_VOLT_INVERSE_METER_RELATIONSHIP                     = 8.065543937d5            !!m^-1                     
real(c_double), parameter :: D_ELECTRON_VOLT_INVERSE_METER_RELATIONSHIP                   = 0.0                      !!m^-1                     

real(c_double), parameter :: ELECTRON_VOLT_JOULE_RELATIONSHIP                             = 1.602176634d-19          !!J                        
real(c_double), parameter :: D_ELECTRON_VOLT_JOULE_RELATIONSHIP                           = 0.0                      !!J                        

real(c_double), parameter :: ELECTRON_VOLT_KELVIN_RELATIONSHIP                            = 1.160451812d4            !!K                        
real(c_double), parameter :: D_ELECTRON_VOLT_KELVIN_RELATIONSHIP                          = 0.0                      !!K                        

real(c_double), parameter :: ELECTRON_VOLT_KILOGRAM_RELATIONSHIP                          = 1.782661921d-36          !!kg                       
real(c_double), parameter :: D_ELECTRON_VOLT_KILOGRAM_RELATIONSHIP                        = 0.0                      !!kg                       

real(c_double), parameter :: ELEMENTARY_CHARGE                                            = 1.602176634d-19          !!C                        
real(c_double), parameter :: D_ELEMENTARY_CHARGE                                          = 0.0                      !!C                        

real(c_double), parameter :: ELEMENTARY_CHARGE_OVER_H_BAR                                 = 1.519267447d15           !!A J^-1                   
real(c_double), parameter :: D_ELEMENTARY_CHARGE_OVER_H_BAR                               = 0.0                      !!A J^-1                   

real(c_double), parameter :: FARADAY_CONSTANT                                             = 96485.33212              !!C mol^-1                 
real(c_double), parameter :: D_FARADAY_CONSTANT                                           = 0.0                      !!C mol^-1                 
...
real(c_double), parameter :: D_FIRST_RADIATION_CONSTANT                                   = 0.0                      !!W m^2                    

real(c_double), parameter :: FIRST_RADIATION_CONSTANT_FOR_SPECTRAL_RADIANCE               = 1.191042972d-16          !!W m^2 sr^-1              
real(c_double), parameter :: D_FIRST_RADIATION_CONSTANT_FOR_SPECTRAL_RADIANCE             = 0.0                      !!W m^2 sr^-1              
...
real(c_double), parameter :: HARTREE_ELECTRON_VOLT_RELATIONSHIP                           = 27.211386245988          !!eV                       
real(c_double), parameter :: D_HARTREE_ELECTRON_VOLT_RELATIONSHIP                         = 0.000000000053           !!eV                       
...
real(c_double), parameter :: HARTREE_ENERGY_IN_EV                                         = 27.211386245988          !!eV                       
real(c_double), parameter :: D_HARTREE_ENERGY_IN_EV                                       = 0.000000000053           !!eV                       
...
real(c_double), parameter :: HELION_ELECTRON_MASS_RATIO                                   = 5495.88528007            !!                         
real(c_double), parameter :: D_HELION_ELECTRON_MASS_RATIO                                 = 0.00000024               !!                         

real(c_double), parameter :: HELION_G_FACTOR                                              = -4.255250615             !!                         
real(c_double), parameter :: D_HELION_G_FACTOR                                            = 0.000000050              !!                         
...
real(c_double), parameter :: HELION_MAG__MOM__TO_NUCLEAR_MAGNETON_RATIO                   = -2.127625307             !!                         
real(c_double), parameter :: D_HELION_MAG__MOM__TO_NUCLEAR_MAGNETON_RATIO                 = 0.000000025              !!                         
...
real(c_double), parameter :: HELION_MASS_ENERGY_EQUIVALENT_IN_MEV                         = 2808.39160743            !!MeV                      
real(c_double), parameter :: D_HELION_MASS_ENERGY_EQUIVALENT_IN_MEV                       = 0.00000085               !!MeV                      

real(c_double), parameter :: HELION_MASS_IN_U                                             = 3.014932247175           !!u                        
real(c_double), parameter :: D_HELION_MASS_IN_U                                           = 0.000000000097           !!u                        
...
real(c_double), parameter :: HELION_PROTON_MASS_RATIO                                     = 2.99315267167            !!                         
real(c_double), parameter :: D_HELION_PROTON_MASS_RATIO                                   = 0.00000000013            !!                         

real(c_double), parameter :: HELION_RELATIVE_ATOMIC_MASS                                  = 3.014932247175           !!                         
real(c_double), parameter :: D_HELION_RELATIVE_ATOMIC_MASS                                = 0.000000000097           !!                         
...
real(c_double), parameter :: D_HERTZ_ELECTRON_VOLT_RELATIONSHIP                           = 0.0                      !!eV                       
...
real(c_double), parameter :: D_HERTZ_INVERSE_METER_RELATIONSHIP                           = 0.0                      !!m^-1                     

real(c_double), parameter :: HERTZ_JOULE_RELATIONSHIP                                     = 6.62607015d-34           !!J                        
real(c_double), parameter :: D_HERTZ_JOULE_RELATIONSHIP                                   = 0.0                      !!J                        

real(c_double), parameter :: HERTZ_KELVIN_RELATIONSHIP                                    = 4.799243073d-11          !!K                        
real(c_double), parameter :: D_HERTZ_KELVIN_RELATIONSHIP                                  = 0.0                      !!K                        

real(c_double), parameter :: HERTZ_KILOGRAM_RELATIONSHIP                                  = 7.372497323d-51          !!kg                       
real(c_double), parameter :: D_HERTZ_KILOGRAM_RELATIONSHIP                                = 0.0                      !!kg                       

real(c_double), parameter :: HYPERFINE_TRANSITION_FREQUENCY_OF_CS_133                     = 9192631770.0             !!Hz                       
real(c_double), parameter :: D_HYPERFINE_TRANSITION_FREQUENCY_OF_CS_133                   = 0.0                      !!Hz                       

real(c_double), parameter :: INVERSE_FINE_STRUCTURE_CONSTANT                              = 137.035999084            !!                         
real(c_double), parameter :: D_INVERSE_FINE_STRUCTURE_CONSTANT                            = 0.000000021              !!                         
...
real(c_double), parameter :: D_INVERSE_METER_ELECTRON_VOLT_RELATIONSHIP                   = 0.0                      !!eV                       
...
real(c_double), parameter :: INVERSE_METER_HERTZ_RELATIONSHIP                             = 299792458.0              !!Hz                       
real(c_double), parameter :: D_INVERSE_METER_HERTZ_RELATIONSHIP                           = 0.0                      !!Hz                       

real(c_double), parameter :: INVERSE_METER_JOULE_RELATIONSHIP                             = 1.986445857d-25          !!J                        
real(c_double), parameter :: D_INVERSE_METER_JOULE_RELATIONSHIP                           = 0.0                      !!J                        

real(c_double), parameter :: INVERSE_METER_KELVIN_RELATIONSHIP                            = 1.438776877d-2           !!K                        
real(c_double), parameter :: D_INVERSE_METER_KELVIN_RELATIONSHIP                          = 0.0                      !!K                        

real(c_double), parameter :: INVERSE_METER_KILOGRAM_RELATIONSHIP                          = 2.210219094d-42          !!kg                       
real(c_double), parameter :: D_INVERSE_METER_KILOGRAM_RELATIONSHIP                        = 0.0                      !!kg                       

real(c_double), parameter :: INVERSE_OF_CONDUCTANCE_QUANTUM                               = 12906.40372              !!ohm                      
real(c_double), parameter :: D_INVERSE_OF_CONDUCTANCE_QUANTUM                             = 0.0                      !!ohm                      

real(c_double), parameter :: JOSEPHSON_CONSTANT                                           = 483597.8484d9            !!Hz V^-1                  
real(c_double), parameter :: D_JOSEPHSON_CONSTANT                                         = 0.0                      !!Hz V^-1                  
...
real(c_double), parameter :: D_JOULE_ELECTRON_VOLT_RELATIONSHIP                           = 0.0                      !!eV                       
...
real(c_double), parameter :: D_JOULE_HERTZ_RELATIONSHIP                                   = 0.0                      !!Hz                       

real(c_double), parameter :: JOULE_INVERSE_METER_RELATIONSHIP                             = 5.034116567d24           !!m^-1                     
real(c_double), parameter :: D_JOULE_INVERSE_METER_RELATIONSHIP                           = 0.0                      !!m^-1                     

real(c_double), parameter :: JOULE_KELVIN_RELATIONSHIP                                    = 7.242970516d22           !!K                        
real(c_double), parameter :: D_JOULE_KELVIN_RELATIONSHIP                                  = 0.0                      !!K                        

real(c_double), parameter :: JOULE_KILOGRAM_RELATIONSHIP                                  = 1.112650056d-17          !!kg                       
real(c_double), parameter :: D_JOULE_KILOGRAM_RELATIONSHIP                                = 0.0                      !!kg                       
...
real(c_double), parameter :: D_KELVIN_ELECTRON_VOLT_RELATIONSHIP                          = 0.0                      !!eV                       
...
real(c_double), parameter :: D_KELVIN_HERTZ_RELATIONSHIP                                  = 0.0                      !!Hz                       

real(c_double), parameter :: KELVIN_INVERSE_METER_RELATIONSHIP                            = 69.50348004              !!m^-1                     
real(c_double), parameter :: D_KELVIN_INVERSE_METER_RELATIONSHIP                          = 0.0                      !!m^-1                     

real(c_double), parameter :: KELVIN_JOULE_RELATIONSHIP                                    = 1.380649d-23             !!J                        
real(c_double), parameter :: D_KELVIN_JOULE_RELATIONSHIP                                  = 0.0                      !!J                        

real(c_double), parameter :: KELVIN_KILOGRAM_RELATIONSHIP                                 = 1.536179187d-40          !!kg                       
real(c_double), parameter :: D_KELVIN_KILOGRAM_RELATIONSHIP                               = 0.0                      !!kg                       
...
real(c_double), parameter :: D_KILOGRAM_ELECTRON_VOLT_RELATIONSHIP                        = 0.0                      !!eV                       
...
real(c_double), parameter :: D_KILOGRAM_HERTZ_RELATIONSHIP                                = 0.0                      !!Hz                       

real(c_double), parameter :: KILOGRAM_INVERSE_METER_RELATIONSHIP                          = 4.524438335d41           !!m^-1                     
real(c_double), parameter :: D_KILOGRAM_INVERSE_METER_RELATIONSHIP                        = 0.0                      !!m^-1                     

real(c_double), parameter :: KILOGRAM_JOULE_RELATIONSHIP                                  = 8.987551787d16           !!J                        
real(c_double), parameter :: D_KILOGRAM_JOULE_RELATIONSHIP                                = 0.0                      !!J                        

real(c_double), parameter :: KILOGRAM_KELVIN_RELATIONSHIP                                 = 6.509657260d39           !!K                        
real(c_double), parameter :: D_KILOGRAM_KELVIN_RELATIONSHIP                               = 0.0                      !!K                        
...
real(c_double), parameter :: D_LOSCHMIDT_CONSTANT__273_15_K__100_KPA                      = 0.0                      !!m^-3                     

real(c_double), parameter :: LOSCHMIDT_CONSTANT__273_15_K__101_325_KPA                    = 2.686780111d25           !!m^-3                     
real(c_double), parameter :: D_LOSCHMIDT_CONSTANT__273_15_K__101_325_KPA                  = 0.0                      !!m^-3                     

real(c_double), parameter :: LUMINOUS_EFFICACY                                            = 683.0                    !!lm W^-1                  
real(c_double), parameter :: D_LUMINOUS_EFFICACY                                          = 0.0                      !!lm W^-1                  

real(c_double), parameter :: MAG__FLUX_QUANTUM                                            = 2.067833848d-15          !!Wb                       
real(c_double), parameter :: D_MAG__FLUX_QUANTUM                                          = 0.0                      !!Wb                       

real(c_double), parameter :: MOLAR_GAS_CONSTANT                                           = 8.314462618              !!J mol^-1 K^-1            
real(c_double), parameter :: D_MOLAR_GAS_CONSTANT                                         = 0.0                      !!J mol^-1 K^-1            
...
real(c_double), parameter :: D_MOLAR_PLANCK_CONSTANT                                      = 0.0                      !!J Hz^-1 mol^-1           

real(c_double), parameter :: MOLAR_VOLUME_OF_IDEAL_GAS__273_15_K__100_KPA                 = 22.71095464d-3           !!m^3 mol^-1               
real(c_double), parameter :: D_MOLAR_VOLUME_OF_IDEAL_GAS__273_15_K__100_KPA               = 0.0                      !!m^3 mol^-1               

real(c_double), parameter :: MOLAR_VOLUME_OF_IDEAL_GAS__273_15_K__101_325_KPA             = 22.41396954d-3           !!m^3 mol^-1               
real(c_double), parameter :: D_MOLAR_VOLUME_OF_IDEAL_GAS__273_15_K__101_325_KPA           = 0.0                      !!m^3 mol^-1               
...
real(c_double), parameter :: MUON_ELECTRON_MASS_RATIO                                     = 206.7682830              !!                         
real(c_double), parameter :: D_MUON_ELECTRON_MASS_RATIO                                   = 0.0000046                !!                         

real(c_double), parameter :: MUON_G_FACTOR                                                = -2.0023318418            !!                         
real(c_double), parameter :: D_MUON_G_FACTOR                                              = 0.0000000013             !!                         
...
real(c_double), parameter :: MUON_MAG__MOM__TO_NUCLEAR_MAGNETON_RATIO                     = -8.89059703              !!                         
real(c_double), parameter :: D_MUON_MAG__MOM__TO_NUCLEAR_MAGNETON_RATIO                   = 0.00000020               !!                         
...
real(c_double), parameter :: MUON_MASS_ENERGY_EQUIVALENT_IN_MEV                           = 105.6583755              !!MeV                      
real(c_double), parameter :: D_MUON_MASS_ENERGY_EQUIVALENT_IN_MEV                         = 0.0000023                !!MeV                      

real(c_double), parameter :: MUON_MASS_IN_U                                               = 0.1134289259             !!u                        
real(c_double), parameter :: D_MUON_MASS_IN_U                                             = 0.0000000025             !!u                        
...
real(c_double), parameter :: MUON_NEUTRON_MASS_RATIO                                      = 0.1124545170             !!                         
real(c_double), parameter :: D_MUON_NEUTRON_MASS_RATIO                                    = 0.0000000025             !!                         

real(c_double), parameter :: MUON_PROTON_MAG__MOM__RATIO                                  = -3.183345142             !!                         
real(c_double), parameter :: D_MUON_PROTON_MAG__MOM__RATIO                                = 0.000000071              !!                         

real(c_double), parameter :: MUON_PROTON_MASS_RATIO                                       = 0.1126095264             !!                         
real(c_double), parameter :: D_MUON_PROTON_MASS_RATIO                                     = 0.0000000025             !!                         
...
real(c_double), parameter :: D_NATURAL_UNIT_OF_ACTION                                     = 0.0                      !!J s                      

real(c_double), parameter :: NATURAL_UNIT_OF_ACTION_IN_EV_S                               = 6.582119569d-16          !!eV s                     
real(c_double), parameter :: D_NATURAL_UNIT_OF_ACTION_IN_EV_S                             = 0.0                      !!eV s                     
...
real(c_double), parameter :: NATURAL_UNIT_OF_ENERGY_IN_MEV                                = 0.51099895000            !!MeV                      
real(c_double), parameter :: D_NATURAL_UNIT_OF_ENERGY_IN_MEV                              = 0.00000000015            !!MeV                      
...
real(c_double), parameter :: NATURAL_UNIT_OF_MOMENTUM_IN_MEV_C                            = 0.51099895000            !!MeV/c                    
real(c_double), parameter :: D_NATURAL_UNIT_OF_MOMENTUM_IN_MEV_C                          = 0.00000000015            !!MeV/c                    
...
real(c_double), parameter :: NATURAL_UNIT_OF_VELOCITY                                     = 299792458.0              !!m s^-1                   
real(c_double), parameter :: D_NATURAL_UNIT_OF_VELOCITY                                   = 0.0                      !!m s^-1                   
...
real(c_double), parameter :: NEUTRON_ELECTRON_MASS_RATIO                                  = 1838.68366173            !!                         
real(c_double), parameter :: D_NEUTRON_ELECTRON_MASS_RATIO                                = 0.00000089               !!                         

real(c_double), parameter :: NEUTRON_G_FACTOR                                             = -3.82608545              !!                         
real(c_double), parameter :: D_NEUTRON_G_FACTOR                                           = 0.00000090               !!                         
...
real(c_double), parameter :: NEUTRON_GYROMAG__RATIO_IN_MHZ_T                              = 29.1646931               !!MHz T^-1                 
real(c_double), parameter :: D_NEUTRON_GYROMAG__RATIO_IN_MHZ_T                            = 0.0000069                !!MHz T^-1                 
...
real(c_double), parameter :: NEUTRON_MAG__MOM__TO_NUCLEAR_MAGNETON_RATIO                  = -1.91304273              !!                         
real(c_double), parameter :: D_NEUTRON_MAG__MOM__TO_NUCLEAR_MAGNETON_RATIO                = 0.00000045               !!                         
...
real(c_double), parameter :: NEUTRON_MASS_ENERGY_EQUIVALENT_IN_MEV                        = 939.56542052             !!MeV                      
real(c_double), parameter :: D_NEUTRON_MASS_ENERGY_EQUIVALENT_IN_MEV                      = 0.00000054               !!MeV                      

real(c_double), parameter :: NEUTRON_MASS_IN_U                                            = 1.00866491595            !!u                        
real(c_double), parameter :: D_NEUTRON_MASS_IN_U                                          = 0.00000000049            !!u                        
...
real(c_double), parameter :: NEUTRON_MUON_MASS_RATIO                                      = 8.89248406               !!                         
real(c_double), parameter :: D_NEUTRON_MUON_MASS_RATIO                                    = 0.00000020               !!                         

real(c_double), parameter :: NEUTRON_PROTON_MAG__MOM__RATIO                               = -0.68497934              !!                         
real(c_double), parameter :: D_NEUTRON_PROTON_MAG__MOM__RATIO                             = 0.00000016               !!                         
...
real(c_double), parameter :: NEUTRON_PROTON_MASS_DIFFERENCE_ENERGY_EQUIVALENT_IN_MEV      = 1.29333236               !!MeV                      
real(c_double), parameter :: D_NEUTRON_PROTON_MASS_DIFFERENCE_ENERGY_EQUIVALENT_IN_MEV    = 0.00000046               !!MeV                      
...
real(c_double), parameter :: NEUTRON_PROTON_MASS_RATIO                                    = 1.00137841931            !!                         
real(c_double), parameter :: D_NEUTRON_PROTON_MASS_RATIO                                  = 0.00000000049            !!                         

real(c_double), parameter :: NEUTRON_RELATIVE_ATOMIC_MASS                                 = 1.00866491595            !!                         
real(c_double), parameter :: D_NEUTRON_RELATIVE_ATOMIC_MASS                               = 0.00000000049            !!                         

real(c_double), parameter :: NEUTRON_TAU_MASS_RATIO                                       = 0.528779                 !!                         
real(c_double), parameter :: D_NEUTRON_TAU_MASS_RATIO                                     = 0.000036                 !!                         

real(c_double), parameter :: NEUTRON_TO_SHIELDED_PROTON_MAG__MOM__RATIO                   = -0.68499694              !!                         
real(c_double), parameter :: D_NEUTRON_TO_SHIELDED_PROTON_MAG__MOM__RATIO                 = 0.00000016               !!                         
...
real(c_double), parameter :: NUCLEAR_MAGNETON_IN_MHZ_T                                    = 7.6225932291             !!MHz T^-1                 
real(c_double), parameter :: D_NUCLEAR_MAGNETON_IN_MHZ_T                                  = 0.0000000023             !!MHz T^-1                 

real(c_double), parameter :: PLANCK_CONSTANT                                              = 6.62607015d-34           !!J Hz^-1                  
real(c_double), parameter :: D_PLANCK_CONSTANT                                            = 0.0                      !!J Hz^-1                  

real(c_double), parameter :: PLANCK_CONSTANT_IN_EV_HZ                                     = 4.135667696d-15          !!eV Hz^-1                 
real(c_double), parameter :: D_PLANCK_CONSTANT_IN_EV_HZ                                   = 0.0                      !!eV Hz^-1                 
...
real(c_double), parameter :: PROTON_ELECTRON_MASS_RATIO                                   = 1836.15267343            !!                         
real(c_double), parameter :: D_PROTON_ELECTRON_MASS_RATIO                                 = 0.00000011               !!                         

real(c_double), parameter :: PROTON_G_FACTOR                                              = 5.5856946893             !!                         
real(c_double), parameter :: D_PROTON_G_FACTOR                                            = 0.0000000016             !!                         
...
real(c_double), parameter :: PROTON_GYROMAG__RATIO_IN_MHZ_T                               = 42.577478518             !!MHz T^-1                 
real(c_double), parameter :: D_PROTON_GYROMAG__RATIO_IN_MHZ_T                             = 0.000000018              !!MHz T^-1                 
...
real(c_double), parameter :: PROTON_MAG__MOM__TO_NUCLEAR_MAGNETON_RATIO                   = 2.79284734463            !!                         
real(c_double), parameter :: D_PROTON_MAG__MOM__TO_NUCLEAR_MAGNETON_RATIO                 = 0.00000000082            !!                         
...
real(c_double), parameter :: PROTON_MASS_ENERGY_EQUIVALENT_IN_MEV                         = 938.27208816             !!MeV                      
real(c_double), parameter :: D_PROTON_MASS_ENERGY_EQUIVALENT_IN_MEV                       = 0.00000029               !!MeV                      

real(c_double), parameter :: PROTON_MASS_IN_U                                             = 1.007276466621           !!u                        
real(c_double), parameter :: D_PROTON_MASS_IN_U                                           = 0.000000000053           !!u                        
...
real(c_double), parameter :: PROTON_MUON_MASS_RATIO                                       = 8.88024337               !!                         
real(c_double), parameter :: D_PROTON_MUON_MASS_RATIO                                     = 0.00000020               !!                         

real(c_double), parameter :: PROTON_NEUTRON_MAG__MOM__RATIO                               = -1.45989805              !!                         
real(c_double), parameter :: D_PROTON_NEUTRON_MAG__MOM__RATIO                             = 0.00000034               !!                         

real(c_double), parameter :: PROTON_NEUTRON_MASS_RATIO                                    = 0.99862347812            !!                         
real(c_double), parameter :: D_PROTON_NEUTRON_MASS_RATIO                                  = 0.00000000049            !!                         

real(c_double), parameter :: PROTON_RELATIVE_ATOMIC_MASS                                  = 1.007276466621           !!                         
real(c_double), parameter :: D_PROTON_RELATIVE_ATOMIC_MASS                                = 0.000000000053           !!                         
...
real(c_double), parameter :: PROTON_TAU_MASS_RATIO                                        = 0.528051                 !!                         
real(c_double), parameter :: D_PROTON_TAU_MASS_RATIO                                      = 0.000036                 !!                         
...
real(c_double), parameter :: D_REDUCED_PLANCK_CONSTANT                                    = 0.0                      !!J s                      

real(c_double), parameter :: REDUCED_PLANCK_CONSTANT_IN_EV_S                              = 6.582119569d-16          !!eV s                     
real(c_double), parameter :: D_REDUCED_PLANCK_CONSTANT_IN_EV_S                            = 0.0                      !!eV s                     

real(c_double), parameter :: REDUCED_PLANCK_CONSTANT_TIMES_C_IN_MEV_FM                    = 197.3269804              !!MeV fm                   
real(c_double), parameter :: D_REDUCED_PLANCK_CONSTANT_TIMES_C_IN_MEV_FM                  = 0.0                      !!MeV fm                   
...
real(c_double), parameter :: RYDBERG_CONSTANT                                             = 10973731.568160          !!m^-1                     
real(c_double), parameter :: D_RYDBERG_CONSTANT                                           = 0.000021                 !!m^-1                     
...
real(c_double), parameter :: RYDBERG_CONSTANT_TIMES_HC_IN_EV                              = 13.605693122994          !!eV                       
real(c_double), parameter :: D_RYDBERG_CONSTANT_TIMES_HC_IN_EV                            = 0.000000000026           !!eV                       
...
real(c_double), parameter :: SACKUR_TETRODE_CONSTANT__1_K__100_KPA                        = -1.15170753706           !!                         
real(c_double), parameter :: D_SACKUR_TETRODE_CONSTANT__1_K__100_KPA                      = 0.00000000045            !!                         

real(c_double), parameter :: SACKUR_TETRODE_CONSTANT__1_K__101_325_KPA                    = -1.16487052358           !!                         
real(c_double), parameter :: D_SACKUR_TETRODE_CONSTANT__1_K__101_325_KPA                  = 0.00000000045            !!                         

real(c_double), parameter :: SECOND_RADIATION_CONSTANT                                    = 1.438776877d-2           !!m K                      
real(c_double), parameter :: D_SECOND_RADIATION_CONSTANT                                  = 0.0                      !!m K                      
...
real(c_double), parameter :: SHIELDED_HELION_GYROMAG__RATIO_IN_MHZ_T                      = 32.43409942              !!MHz T^-1                 
real(c_double), parameter :: D_SHIELDED_HELION_GYROMAG__RATIO_IN_MHZ_T                    = 0.00000038               !!MHz T^-1                 
...
real(c_double), parameter :: SHIELDED_HELION_MAG__MOM__TO_NUCLEAR_MAGNETON_RATIO          = -2.127497719             !!                         
real(c_double), parameter :: D_SHIELDED_HELION_MAG__MOM__TO_NUCLEAR_MAGNETON_RATIO        = 0.000000025              !!                         

real(c_double), parameter :: SHIELDED_HELION_TO_PROTON_MAG__MOM__RATIO                    = -0.7617665618            !!                         
real(c_double), parameter :: D_SHIELDED_HELION_TO_PROTON_MAG__MOM__RATIO                  = 0.0000000089             !!                         

real(c_double), parameter :: SHIELDED_HELION_TO_SHIELDED_PROTON_MAG__MOM__RATIO           = -0.7617861313            !!                         
real(c_double), parameter :: D_SHIELDED_HELION_TO_SHIELDED_PROTON_MAG__MOM__RATIO         = 0.0000000033             !!                         
...
real(c_double), parameter :: SHIELDED_PROTON_GYROMAG__RATIO_IN_MHZ_T                      = 42.57638474              !!MHz T^-1                 
real(c_double), parameter :: D_SHIELDED_PROTON_GYROMAG__RATIO_IN_MHZ_T                    = 0.00000046               !!MHz T^-1                 
...
real(c_double), parameter :: SHIELDED_PROTON_MAG__MOM__TO_NUCLEAR_MAGNETON_RATIO          = 2.792775599              !!                         
real(c_double), parameter :: D_SHIELDED_PROTON_MAG__MOM__TO_NUCLEAR_MAGNETON_RATIO        = 0.000000030              !!                         
...
real(c_double), parameter :: SPEED_OF_LIGHT_IN_VACUUM                                     = 299792458.0              !!m s^-1                   
real(c_double), parameter :: D_SPEED_OF_LIGHT_IN_VACUUM                                   = 0.0                      !!m s^-1                   

real(c_double), parameter :: STANDARD_ACCELERATION_OF_GRAVITY                             = 9.80665                  !!m s^-2                   
real(c_double), parameter :: D_STANDARD_ACCELERATION_OF_GRAVITY                           = 0.0                      !!m s^-2                   

real(c_double), parameter :: STANDARD_ATMOSPHERE                                          = 101325.0                 !!Pa                       
real(c_double), parameter :: D_STANDARD_ATMOSPHERE                                        = 0.0                      !!Pa                       

real(c_double), parameter :: STANDARD_STATE_PRESSURE                                      = 100000.0                 !!Pa                       
real(c_double), parameter :: D_STANDARD_STATE_PRESSURE                                    = 0.0                      !!Pa                       

real(c_double), parameter :: STEFAN_BOLTZMANN_CONSTANT                                    = 5.670374419d-8           !!W m^-2 K^-4              
real(c_double), parameter :: D_STEFAN_BOLTZMANN_CONSTANT                                  = 0.0                      !!W m^-2 K^-4              
...
real(c_double), parameter :: TAU_ELECTRON_MASS_RATIO                                      = 3477.23                  !!                         
real(c_double), parameter :: D_TAU_ELECTRON_MASS_RATIO                                    = 0.23                     !!                         

real(c_double), parameter :: TAU_ENERGY_EQUIVALENT                                        = 1776.86                  !!MeV                      
real(c_double), parameter :: D_TAU_ENERGY_EQUIVALENT                                      = 0.12                     !!MeV                      
...
real(c_double), parameter :: TAU_MASS_IN_U                                                = 1.90754                  !!u                        
real(c_double), parameter :: D_TAU_MASS_IN_U                                              = 0.00013                  !!u                        

real(c_double), parameter :: TAU_MOLAR_MASS                                               = 1.90754d-3               !!kg mol^-1                
real(c_double), parameter :: D_TAU_MOLAR_MASS                                             = 0.00013d-3               !!kg mol^-1                

real(c_double), parameter :: TAU_MUON_MASS_RATIO                                          = 16.8170                  !!                         
real(c_double), parameter :: D_TAU_MUON_MASS_RATIO                                        = 0.0011                   !!                         

real(c_double), parameter :: TAU_NEUTRON_MASS_RATIO                                       = 1.89115                  !!                         
real(c_double), parameter :: D_TAU_NEUTRON_MASS_RATIO                                     = 0.00013                  !!                         

real(c_double), parameter :: TAU_PROTON_MASS_RATIO                                        = 1.89376                  !!                         
real(c_double), parameter :: D_TAU_PROTON_MASS_RATIO                                      = 0.00013                  !!                         
...
real(c_double), parameter :: TRITON_ELECTRON_MASS_RATIO                                   = 5496.92153573            !!                         
real(c_double), parameter :: D_TRITON_ELECTRON_MASS_RATIO                                 = 0.00000027               !!                         

real(c_double), parameter :: TRITON_G_FACTOR                                              = 5.957924931              !!                         
real(c_double), parameter :: D_TRITON_G_FACTOR                                            = 0.000000012              !!                         
...
real(c_double), parameter :: TRITON_MAG__MOM__TO_NUCLEAR_MAGNETON_RATIO                   = 2.9789624656             !!                         
real(c_double), parameter :: D_TRITON_MAG__MOM__TO_NUCLEAR_MAGNETON_RATIO                 = 0.0000000059             !!                         
...
real(c_double), parameter :: TRITON_MASS_ENERGY_EQUIVALENT_IN_MEV                         = 2808.92113298            !!MeV                      
real(c_double), parameter :: D_TRITON_MASS_ENERGY_EQUIVALENT_IN_MEV                       = 0.00000085               !!MeV                      

real(c_double), parameter :: TRITON_MASS_IN_U                                             = 3.01550071621            !!u                        
real(c_double), parameter :: D_TRITON_MASS_IN_U                                           = 0.00000000012            !!u                        
...
real(c_double), parameter :: TRITON_PROTON_MASS_RATIO                                     = 2.99371703414            !!                         
real(c_double), parameter :: D_TRITON_PROTON_MASS_RATIO                                   = 0.00000000015            !!                         

real(c_double), parameter :: TRITON_RELATIVE_ATOMIC_MASS                                  = 3.01550071621            !!                         
real(c_double), parameter :: D_TRITON_RELATIVE_ATOMIC_MASS                                = 0.00000000012            !!                         

real(c_double), parameter :: TRITON_TO_PROTON_MAG__MOM__RATIO                             = 1.0666399191             !!                         
real(c_double), parameter :: D_TRITON_TO_PROTON_MAG__MOM__RATIO                           = 0.0000000021             !!                         
...
real(c_double), parameter :: VON_KLITZING_CONSTANT                                        = 25812.80745              !!ohm                      
real(c_double), parameter :: D_VON_KLITZING_CONSTANT                                      = 0.0                      !!ohm                      

real(c_double), parameter :: WEAK_MIXING_ANGLE                                            = 0.22290                  !!                         
real(c_double), parameter :: D_WEAK_MIXING_ANGLE                                          = 0.00030                  !!                         

real(c_double), parameter :: WIEN_FREQUENCY_DISPLACEMENT_LAW_CONSTANT                     = 5.878925757d10           !!Hz K^-1                  
real(c_double), parameter :: D_WIEN_FREQUENCY_DISPLACEMENT_LAW_CONSTANT                   = 0.0                      !!Hz K^-1                  

real(c_double), parameter :: WIEN_WAVELENGTH_DISPLACEMENT_LAW_CONSTANT                    = 2.897771955d-3           !!m K                      
real(c_double), parameter :: D_WIEN_WAVELENGTH_DISPLACEMENT_LAW_CONSTANT                  = 0.0                      !!m K                      

real(c_double), parameter :: W_TO_Z_MASS_RATIO                                            = 0.88153                  !!                         
real(c_double), parameter :: D_W_TO_Z_MASS_RATIO                                          = 0.00017                  !!                         
