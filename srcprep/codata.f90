...
$BLOCK comment --file man/codata.3.prep
NAME
...
DESCRIPTION
  ...
  or uncertainty of a constant.
      ...
      o to_real(self, mold, uncertainty) result(r)  Get the constant value or uncertainty.
                                                    Warning: Some constants cannot be converted to single precision 
                                                    sp reals due to the value of the exponents.
  ...
  the same members as in Fortran. to_real is not exposed in the C API.
  ...
  to_real is not exposed in the Python wrapper.
