...
However, those versions provide only the  documentation of the API generated 
...
\begin{itemize}
\item Reference Manual [PDF]:          \url{https://milanskocic.github.io/codata/latex/codata-refman.pdf}
